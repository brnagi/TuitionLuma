...
enum LumaTheme {
    ...
    static let slate = Color(red: 0.35, green: 0.40, blue: 0.52)
    static let canvas = Color(red: 0.035, green: 0.055, blue: 0.105)
    static let card = Color(red: 0.985, green: 0.99, blue: 1.0)
